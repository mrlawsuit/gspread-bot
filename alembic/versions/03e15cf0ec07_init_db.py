...
Revision ID: 030bcbf5fa0d
Revises: 
Create Date: 2024-10-27 10:03:15.514733
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('planned', 'in_process', 'done', name='maintenancestatus'), nullable=False),
    sa.ForeignKeyConstraint(['vehicle_id'], ['vehicles.id'], ondelete='CASCADE'),
    ...
    op.create_table('maintenances_services',
    ...
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('maintenance_id', 'service_id')
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('maintenances_services')
